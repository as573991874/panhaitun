...
G.DATA.CHOICES = {
  ...
  lv2: {
    ...
    b: { t: '「我一个人打上去。谁的名号也不借。」', tag: 'blade', fx: { xp: 35 }, hint: '独行之道：修为 +35',
  ...
  lv4: {
    ...
    b: { t: '「带走。键帽们也该自由了。」', tag: 'blade', fx: { extra: 3, xp: 45 }, hint: '挑战：下一关多一队追兵，但修为 +45',
  ...
  lv6: {
    ...
    b: { t: '「不用装。回去告诉宗主：我去找他。」', tag: 'blade', fx: { enemyHpMul: 1.15, xp: 60 }, hint: '宣战：下一关敌人更强（+15%），但修为 +60',
  ...
  lv7: {
    ...
    b: { t: '「等我。打赢了宗主，牢就没了。」先赶路。', tag: 'blade', fx: { xp: 45 }, hint: '心无旁骛：修为 +45',
  ...
  lv8: {
    ...
    b: { t: '碾碎他的键根：「你的算法，到此为止。」', tag: 'blade', fx: { xp: 60 }, hint: '斩尽：修为 +60',
  ...
  lv9: {
    ...
    b: { t: '「不怕。祂欠那孩子的，我们今天讨回来。」', tag: 'blade', fx: { wave: 100, xp: 40 }, hint: '讨债：终章开局音波满盈，修为 +40',
